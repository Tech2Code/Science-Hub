  ...
  return (
    ...
    <div className="page-stack">
      <div className="page-header">
        ...
        <Button variant="primary" href="/purchases/vendors/new">
                ...
                <tr key={v.id}>
                  ...
                  <Cell col={COLUMNS[6]}>
                    <div className="table-actions">
                      ...
                      <Button variant="editOutline" size="sm" onClick={() => { setOpeningEditId(v.id); router.push(`/purchases/vendors/${v.id}/edit`); }}>
                      ...
                      <Button variant="dangerOutline" size="sm" onClick={() => setDeleteTarget(v)}>
