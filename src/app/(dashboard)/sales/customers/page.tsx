            ...
            <tbody>
              {showSkeleton ? (
                ...
                <tr key={c.id}>
                  ...
                  <Cell col={COLUMNS[5]} className={styles.stickyActions}>
