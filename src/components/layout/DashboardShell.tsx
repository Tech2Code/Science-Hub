...
function ThemeToggle() {
  const { toggle, isAuto, setAuto } = useTheme();
  return (
    <>
      <button
        ...
        aria-pressed={isAuto}
        title={isAuto ? "Auto theme on (7 PM–6 AM = dark) — click to switch to manual" : "Switch to auto day/night theme"}
        className={isAuto ? styles.collapseBtnActive : styles.collapseBtn}
      >
