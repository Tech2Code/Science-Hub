...
export function Modal({ open, title, onClose, maxWidth, children }: Props) {
  ...
  return createPortal(
    <div className={styles.overlay} role="dialog" aria-modal="true" aria-label={title}>
      ...
      <div className={styles.center}>
        <div className={styles.dialog} style={maxWidth ? { maxWidth } : undefined} ref={dialogRef} tabIndex={-1}>
