...
const PRODUCT_COLUMNS: Column[] = [
  ...
  { label: "Selling Price", cls: "table-th-right", mobile: "label" },
          ...
          <table className="table-base">
            <thead>
              <tr>
                <th>Name</th>
                <th>SKU</th>
                <th className="table-th-right">Selling Price</th>
            ...
            <tbody>
              {loading ? (
                ...
                <tr key={p.id}>
                  ...
                  <td data-label="Selling Price" className="table-td-right">₹{p.price.toLocaleString("en-IN")}</td>
